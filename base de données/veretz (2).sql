...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  Dim 26 avr. 2020 à 12:02
...
(6, 'Le Sorceleur', 'Andrzej Sapkowski', 'Milady', 'fantasy', 'neuf', '1990', 'Le Sorceleur (en polonais : Wiedźmin) est une série littéraire polonaise de fantasy écrite par Andrzej Sapkowski et publiée entre 1990 et 2018. Inspirée des univers classiques de la fantasy avec des ajouts issus de la mythologie slave et de l\'histoire polonaise, elle se compose de nouvelles ainsi que de romans qui retracent la vie et les aventures du sorceleur Geralt de Riv. Les sorceleurs sont des tueurs de monstres, entraînés physiquement dès leur plus jeune âge et ayant subi des mutations génétiques leur conférant des capacités surnaturelles.  Son adaptation en jeu vidéo, intitulée The Witcher (2007) et ses deux suites ont contribué à sa notoriété.  En France, la série a d’abord été éditée par la maison d’édition Bragelonne, puis rééditée par sa filiale Milady. L\'ordre initial de parution n\'a pas été respecté, l\'éditeur français lui ayant préféré l\'ordre chronologique diégétique. Seul le livre La Saison des orages n’a pas reçu de numéro de tomaison.', 10, NULL),
(9, 'Harry Potter 2', 'a', 'a', 'a', 'a', 'a', 'a', 3, NULL),
